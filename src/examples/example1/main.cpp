...
int OpenGLEngine::main(int argc, char** argv)
{
  ...
  //entity1->GetMaterialComponent()->LoadTexture("../../data/textures/container.png", MaterialComponent::TextureFormat::Texture2D, MaterialComponent::TextureTarget::Diffuse);
  //entity1->GetMaterialComponent()->LoadTexture("../../data/textures/container_specular.png", MaterialComponent::TextureFormat::Texture2D, MaterialComponent::TextureTarget::Specular);
  //entity1->GetMaterialComponent()->SetAmbient(glm::vec3(0.5f));
  //entity1->GetMaterialComponent()->SetDiffuse(glm::vec3(0.2f));
  //entity1->GetMaterialComponent()->SetSpecular(glm::vec3(20.0f));
  ...
  //entity2->GetTransformComponent()->SetPosition(glm::vec3(0.0f, 0.0f, 0.0f));

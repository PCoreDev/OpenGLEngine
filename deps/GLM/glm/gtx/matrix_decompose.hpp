...
///
/// Decomposes a model matrix to traslations, rotation and scale components
...
namespace glm
{
	...
	GLM_FUNC_DECL bool decompose(
		...
		vec<3, T, Q> & scale, qua<T, Q> & orientation, vec<3, T, Q> & traslation, vec<3, T, Q> & skew, vec<4, T, Q> & perspective);
